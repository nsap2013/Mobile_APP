...
//				}
		...
		//		rowRepActiveTimeMatLyt.addRow(rowRepEmptyRow1);
				...
				var rowRepOnOffSegBtn = new sap.ui.commons.SegmentedButton(dynamicId + 'rowRepOnOffSegBtn',{visible:false, buttons : [new sap.ui.commons.Button(dynamicId + 'rowRepOnSegBtn', {text : that._oBundle.getText("SUBSTITUTION_AUTOMATIC_FORWARDING_ON_STATE"), tooltip : that._oBundle.getText("SUBSTITUTION_AUTOMATIC_FORWARDING_ON_STATE")}),//"ON"
				                                                                                                       new sap.ui.commons.Button(dynamicId + 'rowRepOffSegBtn', {text : that._oBundle.getText("SUBSTITUTION_AUTOMATIC_FORWARDING_OFF_STATE"), tooltip : that._oBundle.getText("SUBSTITUTION_AUTOMATIC_FORWARDING_OFF_STATE")})//"OFF"
																																																				]});
