 ...
 */
	...
	sap.uiext.inbox.InboxSecondaryFilterValuesEnum = {
		/**
		 * Enum Values for Status Secondary Filter
		 * @public
		 */
		Status : {
			/**
		...
		/**
		 * 
		 * Enum Values for Priority Secondary Filter
		 * @public
		 */
		Priority : {
			/**
		...
		/**
		 * 
		 * Enum Values for StartDate Secondary Filter
		 * @public
		 * 
		 */
		StartDate : {
		...
		/**
		 * 
		 * Enum Values for DueDate Secondary Filter
		 * @public
		 * 
		 */
		DueDate : {
